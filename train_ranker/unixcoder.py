...
class UniXcoder(nn.Module):
    ...
    def tokenize(self, inputs, mode="<encoder-only>", max_length=20, padding=False):
        """ 
...
# x = torch.rand((8, 1019)).to(device)
# x = x.long()
# print("Input:",get_memory_diff())

# tokens_embeddings,max_func_embedding = model(x)
...
# tokens_ids = model.tokenize(["def f(a,b): if a>b: return a else return b","1235mdmk lmdoanc lmcsamcksl lm;sc a"],max_length=30,mode="<encoder-only>",padding=True)
