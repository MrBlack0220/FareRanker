...
import io
processor_function = {
    "python": [PythonProcessor.priority_trans]
}


class PriorityTrans(TransformationBase):
    """
    Swapping Operand "a>b" becomes "b<a"
    """

    def __init__(self, parser_path, language):
        super(PriorityTrans, self).__init__(parser_path=parser_path, language=language)
