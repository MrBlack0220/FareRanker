...
processor_function = {"python": [PythonProcessor.functionargs_bugs]}


class FunctionargsBugs(TransformationBase):

    def __init__(self, parser_path, language):
        super(FunctionargsBugs, self).__init__(parser_path=parser_path, language=language)
        self.language = language
        self.transformations = processor_function[language]
        processor_map = {"python": PythonProcessor.get_tokens}
