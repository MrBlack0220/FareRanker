...
processor_function = {
    "python": [PythonProcessor.index_bugs],
}


class IndexBugs(TransformationBase):
    """
    Swapping Operand "a>b" becomes "b<a"
    """

    def __init__(self, parser_path, language):
        super(IndexBugs, self).__init__(parser_path=parser_path, language=language)
