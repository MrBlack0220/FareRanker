...
processor_function = {
    "python": [PythonProcessor.boolean_bugs],
}


class BooleanBugs(TransformationBase):

    def __init__(self, parser_path, language):
        super(BooleanBugs, self).__init__(parser_path=parser_path, language=language)
