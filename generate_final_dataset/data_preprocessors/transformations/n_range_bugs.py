...
processor_function = {
    "python": [PythonProcessor.range_bugs]
}


class RangeBugs(TransformationBase):
    """
    Swapping Operand "a>b" becomes "b<a"
    """

    def __init__(self, parser_path, language):
        super(RangeBugs, self).__init__(parser_path=parser_path, language=language)
